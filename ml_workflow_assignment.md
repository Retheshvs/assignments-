...
Justification: This is the target variable, it directly encodes the outcome we are trying to predict (whether a customer made a repeat purchase within 30 days).
